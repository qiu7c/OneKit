            ...
            VStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    TextField("输入正则...", text: $pattern)
                        ...
                        .onChangeCompat(of: pattern) { _ = parse() }
                ...
                }.padding(.horizontal, 16).onChangeCompat(of: caseInsensitive) { _ = parse() }.onChangeCompat(of: multiline) { _ = parse() }
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    TextEditor(text: $testText)
                        ...
                        .onChangeCompat(of: testText) { _ = parse() }
                }.padding(.horizontal, 16)

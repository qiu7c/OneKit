...
enum ToolCategory: String, CaseIterable, Identifiable, Codable {
    ...
    var icon: String { switch self { case .icons: return "photo.on.rectangle"; case .design: return "paintbrush.fill"; case .developer: return "hammer.fill"; case .utility: return "wrench.and.screwdriver.fill"; case .media: return "play.rectangle.fill"; case .network: return "network" } }
...
extension ToolItem {
    static let builtInTools: [ToolItem] = [
        ...
        .init(id: "color-palette", title: "调色板", subtitle: "取色·色板·图片取色", icon: "paintpalette.fill", category: .design, color: "#F59E0B", isBuiltIn: true, tags: ["颜色"]),
        .init(id: "codec", title: "编解码", subtitle: "JSON·Base64·URL·Unicode·Hash", icon: "curlybraces.square.fill", category: .developer, color: "#10B981", isBuiltIn: true, tags: ["JSON", "编解码"]),
